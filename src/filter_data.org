...
#+RESULTS:
: sys:1: DtypeWarning: Columns (25) have mixed types.Specify dtype option on import or set low_memory=False.
...
print('length of test_hof_df: ', len(test_hof_df))
 ...
 #+RESULTS:
 : length of train_reg_df:  2552
 : length of test_reg_df:  638
 : length of train_hof_df:  181
