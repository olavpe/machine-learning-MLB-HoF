...
print("test_X[:5]: ", test_X[0:10])
for i in range(0,10):
    print("test_X[:5]: ", test_X[0:10][i][0])
    # print("test_X[:5]: ", test_X[0:10][1][1])

# prediction_data = []
# for var in range(0,10):
#     print("test_X[:5]: ", test_X[0:10][var][0])
#     full_row = np.empty(0)
#     for row in range(0,10):
#         # test_X[0:10][var][row]
#         full_row = np.append(full_row, test_X[var][row])
#     prediction_data.append(full_row)
